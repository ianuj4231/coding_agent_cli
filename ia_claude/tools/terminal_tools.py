...
def run_command(command: str) -> str:
   ...
   Args:
       command: Required shell command. The tool-call argument must be named
           exactly ``command``.
   """
...
def run_in_directory(command: str, directory: str) -> str:
   ...
   Args:
       command: Required shell command. The tool-call argument must be named
           exactly ``command``.
       directory: Required working-directory path. The tool-call argument
           must be named exactly ``directory``, not ``path``.
   """
   if not command or not command.strip():
       return "Error: command cannot be empty"
